...
export const siteDataEn: SiteData = {
  ...
  about: {
    heading: 'About',
    intro: [
      'Senior AI Automation Engineer and Backend Developer with a proven track record of architecting scalable enterprise platforms and delivering high-impact autonomous AI solutions, both in corporate environments and as an independent contractor. Expert in designing production-ready multi-agent systems, advanced RAG/GraphRAG architectures, and custom Model Context Protocol (MCP) integrations using Python, n8n orchestration, and agentic frameworks like LangGraph and crewAI.',
      'Deep hands-on experience deploying conversational ecosystems (WhatsApp Official API & Telegram), real-time Voice-AI agents with LiveKit, and self-hosted analytics platforms like Metabase on dedicated server infrastructures. Highly skilled in Java (Spring Boot) and Python (FastAPI, Pandas) microservices deployed on AWS and Azure. Adept at bridging cutting-edge AI with production-grade business applications to drive measurable operational efficiency.',
    ],
